...
**Косяк 2026-05-19:** стратегический план (`docs/strategy/2026-05-19-strategy-may-2026-wp250-full-plan.md`) был ошибочно помещён в этот репозиторий. Перенесён в `DS-my-strategy/inbox/WP-250/`.

**Правило:** в `DS-Knowledge-Index-Tseren` размещаются **только посты** с номерами в формате `docs/YYYY/MM-название-месяца/NNN-YYYY-MM-DD-название/`. Никакие стратегические документы, планы, внутренние артефакты или РП-контексты здесь не хранятся — они живут в `DS-my-strategy` или `DS-ecosystem-development`.

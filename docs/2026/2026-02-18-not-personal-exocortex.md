...
Что именно делают агенты уже сейчас:
...
3. Утром агент-стратег формирует план дня. К 7 утра план в Telegram.
4. При закрытии рабочей сессии агент-экстрактор проверяет: не появилось ли знание для формализации в Pack?
5. Синхронизатор следит, чтобы downstream-репозитории не разъехались с Pack.
6. Бот отвечает ученикам — не из головы, а из MCP-сервера, который индексирует Pack и руководства Aisystant.

Планирование, разбор заметок, извлечение знаний, синхронизация, ответы ученикам — всё это рутина. Агенты берут её на себя. А я занимаюсь содержанием: формулирую различения, проектирую архитектуру, пишу посты, веду семинары.

...
### Оценка через 6 характеристик (ЭМОГСС)
...
| **Современность** | SOTA-сущности в Pack с `edition:` и evidence + приоритетная тройка (CE, DDD, Coupling) + RSCR-триггеры пересмотра |

...
3. **Обеспечивающая система** (harness / обвязка) — совокупность систем и описаний, которые создают среду для работы агента. Включает описания (промпты, инструкции, документацию), инструменты (API, файловый доступ), состояние (память, история). Аналог рабочего места: офис + оборудование + регламенты + доступы — всё вместе.
